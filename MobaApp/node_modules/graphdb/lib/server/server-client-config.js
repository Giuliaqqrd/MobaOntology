 ...
 */
var ServerClientConfig = /*#__PURE__*/function (_ClientConfig) {
  /**
   ...
   */
  function ServerClientConfig(endpoint) {
    var _this;
    _classCallCheck(this, ServerClientConfig);
    _this = _callSuper(this, ServerClientConfig, [endpoint]);
    _this.setHeaders({});
    _this.setKeepAlive(true);
    _this.setTimeout(defaultTimeout);
    return _this;
  }
  ...
  /**
    ...
    */
  _inherits(ServerClientConfig, _ClientConfig);
  return _createClass(ServerClientConfig, [{
    key: "setTimeout",
